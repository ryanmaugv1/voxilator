"""
    ...
    Thirdparty MagicaVoxel importer for VOX file format.

    This importer is best suited as it has the option to import "clean"
    version of the mesh which essentially does what the "face filtering"
    mesh optimisation feature helps to do but is manual. However, the
    feature is still available incase people want to use a different VOX
    importer which does not support mesh "cleaning" like this addon:

    https://github.com/RichysHub/MagicaVoxel-VOX-importer

    Authored By TechnistGuru
    Github Repo: https://github.com/technistguru/MagicaVoxel_Importer
